...
FIELDS = [
    ...
    ("skip.lead_in", "Skip: seconds before the transition", 4.0, [0.0, 10.0]),
    ...
    ("selection.compatibility.lookahead_enabled", "Consider the next two possible songs", True, None),
    ...
    ("selection.compatibility.energy_direction", "Energy direction (loudness is a rough clue)", "follow", ["follow", "build", "ease", "surprise"]),
