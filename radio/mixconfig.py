...
FIELDS = [
    ...
    ("selection.exploration_rate", "Unfamiliar music share (fraction)", 0.35, [0.0, 1.0]),
    ("selection.trends_enabled", "Include current public music charts", True, None),
    ("selection.trend_strength", "Chart influence on song choices", 0.3, [0.0, 1.0]),
    ("selection.trends_country", "Chart country", "us", ["us", "gb", "ca", "au", "de", "fr", "jp", "kr", "br", "mx"]),
